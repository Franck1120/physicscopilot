...
func (o *OpenAIBackend) AnalyzeFrame(_ context.Context, _, _, _ string) (*AIResponse, error) {
...
func (b *ClaudeBackend) AnalyzeFrame(_ context.Context, _, _, _ string) (*AIResponse, error) {
